export async function getCategories() {
  if (
    !(
      ...
      process.env.NEXT_PUBLIC_GOOGLE_SPREADSHEET_ID_CATEGORY
    )
  ) {
    throw new Error(
      "GOOGLE credentials must be set as env vars `NEXT_PUBLIC_GOOGLE_SERVICE_ACCOUNT_CLIENT_EMAIL` ,`NEXT_PUBLIC_GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY` and `NEXT_PUBLIC_GOOGLE_SPREADSHEET_ID_CATEGORYGOOGLE_SPREADSHEET_ID_CATEGORY`."
    );
  }
